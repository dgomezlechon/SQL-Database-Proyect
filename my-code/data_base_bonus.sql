CREATE DATABASE bonus_database;
...
-- Schema new_database
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `bonus_database` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
-- -----------------------------------------------------
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bonus_database`.`actor` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bonus_database`.`actor_film` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bonus_database`.`category` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bonus_database`.`film` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bonus_database`.`inventory` (
  ...
  CONSTRAINT `fk_inventory_film1`
    FOREIGN KEY (`film_id`)
    REFERENCES `bonus_database`.`film` (`film_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bonus_database`.`language` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bonus_database`.`rental` (
  ...
  CONSTRAINT `fk_rental_inventory1`
    ...
    REFERENCES `bonus_database`.`inventory` (`inventory_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `new_database2`.`coordinates`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bonus_database`.`coordinates` (
  `film_id` INT NULL DEFAULT NULL,
  `title` TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bonus_database`.`film` (
  ...
  `coordinates_title` TEXT NOT NULL,
  PRIMARY KEY (`title`, `language_language_id`, `coordinates_title`),
  INDEX `fk_film_language1_idx` (`language_language_id` ASC) VISIBLE,
  INDEX `fk_film_coordinates1_idx` (`coordinates_title` ASC) VISIBLE,
  CONSTRAINT `fk_film_language1`
    FOREIGN KEY (`language_language_id`)
    REFERENCES `bonus_database`.`language` (`language_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_film_coordinates1`
    FOREIGN KEY (`coordinates_title`)
    REFERENCES `bonus_database`.`coordinates` (`title`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bonus_database`.`old_hdd` (
  `title` TEXT NULL DEFAULT NULL,
  `release_year` INT NULL DEFAULT NULL,
  `category_id` INT NULL DEFAULT NULL,
  ...
  `film_coordinates_title` TEXT NOT NULL,
  `actor_full name` TEXT NOT NULL,
  `category_category_id` INT NOT NULL,
  PRIMARY KEY (`film_title`, `film_language_language_id`, `film_coordinates_title`, `actor_full name`, `category_category_id`),
  ...
  CONSTRAINT `fk_old_hdd_film1`
    FOREIGN KEY (`film_title` , `film_language_language_id` , `film_coordinates_title`)
    REFERENCES `bonus_database`.`film` (`title` , `language_language_id` , `coordinates_title`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_old_hdd_actor1`
    FOREIGN KEY (`actor_full name`)
    REFERENCES `bonus_database`.`actor` (`full name`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_old_hdd_category1`
    FOREIGN KEY (`category_category_id`)
    REFERENCES `bonus_database`.`category` (`category_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
